...
- Finder defaults: list view, open folders in windows (not tabs), home target path, desktop item visibility, recent tags off, and the Finder toolbar layout with Trash placed before Search.
